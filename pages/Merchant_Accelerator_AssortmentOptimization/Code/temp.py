...
# df = pd.read_sql('SELECT * FROM Consumption_market (product_testing)_Consumption_Market', connection_string)
...
#def update_graph(category_group, category, brand, supplier_name):
#    dff = df
